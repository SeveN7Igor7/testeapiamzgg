...
<html class="loading">
  <head>
    ...
    <title>MAFIOSO GOSTOSO</title>
    <link rel="apple-touch-icon" href="theme-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="https://i.ibb.co/6FRnhDd/cartao-de-credito-nubank-ultravioleta.png">
    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-body text-center">
          <h4 class="mb-2"><strong>CHECKER GG [EM TESTE]</strong></h4>
          <textarea rows="5" class="form-control text-center form-checker mb-2" placeholder="Insira sua Lista"></textarea>

<div class="input-group mb-1">
          <input type="text" class="form-control" id="cookie1" placeholder="COOKIE GRINGO" name="cookie1">&nbsp;       
                 </div>
...
<div class="col-md-4">
  <div class="card mb-2">
    <div class="card-body">
<h5>✅ 𝔸𝕡𝕣𝕠𝕧𝕒𝕕𝕒𝕤:<span class="badge badge-success float-right aprovadas">0</span></h5><hr>

<h5>⛔ ℝ𝕖𝕡𝕣𝕠𝕧𝕒𝕕𝕒𝕤:<span class="badge badge-danger float-right reprovadas">0</span></h5><hr>

<h5>🔄 𝕋𝕖𝕤𝕥𝕒𝕕𝕒𝕤:<span class="badge badge-info float-right testadas">0</span></h5><hr>

<h5>➡️ ℂ𝕒𝕣𝕣𝕖𝕘𝕒𝕕𝕒𝕤:<span class="badge badge-primary float-right carregadas">0</span></h5><hr>
...
Swal.fire({ title: "AVISO", text: "SALDO ILIMITADO, Limite de linhas 200", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
